...
Create a new database (e.g., customer_analysis).

In the customer_analysis.ipynb notebook, update the database connection string with your MySQL username, password, host, and database name.

2. Run Python Notebook:

Open and run the customer_analysis.ipynb notebook.

The first few cells will load the .csv file.

The database cell will create the table and load the data into your MySQL database.

The subsequent cells will perform the EDA.

3. View Power BI Dashboard:

Open the customer_analysis.pbix file in Power BI Desktop.

You may need to update the data source credentials. Go to Transform data -> Data source settings and point Power BI to your local MySQL database (server and database name).

Click Refresh to pull the data and interact with the dashboard.

4. Review Final Reports:

The Customer Shopping Behavior Analysis (1).pdf can be viewed directly.

The Customer_Shopping_Behavior_Presentation.md contains the outline for the Gamma presentation.
